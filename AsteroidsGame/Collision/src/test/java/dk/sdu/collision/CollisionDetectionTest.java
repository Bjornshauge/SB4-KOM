...
class CollisionDetectionTest {
    ...
    @Test
    void collides() {
        assertTrue(collisionDetection.collides(0, 0, 6, 10, 0, 6));
        assertTrue(collisionDetection.collides(0, 0, 5.000001f, 10, 0, 5.000001f));
        assertTrue(collisionDetection.collides(0, 0, 10, 10, 10, 10));
        assertFalse(collisionDetection.collides(0, 0, 5, 10, 0, 5));
        assertFalse(collisionDetection.collides(0, 0, 5, 10, 10, 5));
    }
}