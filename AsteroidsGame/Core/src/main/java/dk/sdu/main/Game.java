...
import dk.sdu.common.data.Color;
import dk.sdu.common.services.IPostEntityProcessingService;
import dk.sdu.common.util.SPILocator;
import dk.sdu.components.PluginInjector;
import dk.sdu.components.IProcessor;
import dk.sdu.managers.GameInputProcessor;
...
public class Game
    ...
    public Game() {
        ...
        this.components.scan("dk.sdu.components");
    ...
    public void create() {
        ...
        ((PluginInjector) components.getBean("pluginInjector")).startPlugins(gameData, world);
    }
